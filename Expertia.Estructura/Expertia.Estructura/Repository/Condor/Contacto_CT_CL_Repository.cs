...
{
    public class Contacto_CT_CL_Repository : OracleBase<Contacto>, ICrud<Contacto>, ISameSPName<Contacto>
    {

        public Contacto_CT_CL_Repository() : base(ConnectionKeys.CondorConnKey)
        {
        }
