...
namespace Expertia.Estructura.Repository.Behavior
{
    public interface IPedidoRepository
    {
        ...
        Operation CreateNM(DatosPedido pedido);
        ...
        void InsertFormaPagoPedidoNM(DatosPedido pedidoRQ, PedidoRS pedidoRS, int intIdFormaPAgo);
        void Update_FechaExpira_Pedido(Pedido pedidoRQ, PedidoRS pedidoRS);
        void Update_FechaExpira_PedidoNM(DatosPedido pedidoRQ, PedidoRS pedidoRS);
