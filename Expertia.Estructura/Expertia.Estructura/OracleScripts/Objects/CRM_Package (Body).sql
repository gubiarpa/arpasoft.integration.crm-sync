CREATE OR REPLACE PACKAGE BODY CRM_MDM_PKG AS
/* *****************************************************************************
   ...
   ---------    ----------    ---------------   ---------------------------------
   1.0          24/07/2019    Billy Arredondo   1. Created this package.
******************************************************************************/
-- ? CLIENTE (B2B, B2C) --
    ...
    BEGIN
        ...
        (
            ...
            P_LogoFoto,
            P_PuntoContacto,
            P_RecibirInformacion,
            P_NivelImportancia,
            P_FechaIniRelacionComercial,
            P_Comentarios,
            P_TipoCuenta,
            P_Estado,
            P_PaisProcedencia
        ...
        INSERT INTO SFC_TB_CLIENTE_B2B
        (
            IDSalesforce,
            RazonSocial,
            Alias,
        ...
        (
            ...
            P_Alias,
            P_CondicionPago,
            P_TipoMonedaDeLineaCredito,
            P_MontoLineaCredito
        );

    END SP_CREAR_CLIENTE_B2B;
    ...
    BEGIN
        ...
        INTO V_CONTADOR
        FROM   DUAL;
    END SP_CREAR_CLIENTE_CANALINFO;
    ...
    BEGIN
        ...
        INTO V_CONTADOR
        FROM   DUAL;
    END SP_CREAR_CLIENTE_DIRECCION;
    ...
    BEGIN
        ...
        INTO V_CONTADOR
        FROM   DUAL;
    END SP_CREAR_CLIENTE_DOCUMENTO;
    ...
    BEGIN
        ...
        INTO V_CONTADOR
        FROM   DUAL;
    END SP_CREAR_CLIENTE_PARTICIPANTE;
